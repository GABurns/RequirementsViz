...
ggplot(data = site, aes(x = time, y = patients, fill = site, label = site, color = site)) +
  ...
  geom_point(aes(x = 0, y = 175),color="black") +
  ...
  geom_point(aes(x = 5, y = 350),color="black") +
  ...
  geom_point(aes(x = 10, y = 525),color="black") +
  ...
  geom_point(aes(x = 25, y = 715),color="black") +
  ...
  geom_point(aes(x = 50, y = 900), color = "black") +
  annotate(
    "text",
    x = 50,
    y = 925,
  ...
  annotate("text", x = 51, y = 600,
           label = "Site A has 500 (57%)\nof patients at study end",
           hjust=0,
           size=3,
           lineheight=.8,
           fontface="bold",
           color=CoporateColours[1]) +
  annotate("text", x = 51, y = 320,
           label = "Site B has 100 (11%)\nof patients at study end",
           hjust=0,
           size=3,
           lineheight=.8,
           fontface="bold",
           color=CoporateColours[2]) +
  annotate("text", x = 51, y = 130,
           label = "Site C has 250 (29%)\nof patients at study end",
           hjust=0,
           size=3,
           lineheight=.8,
           fontface="bold",
           color=CoporateColours[3]) +
  annotate("text", x = 51, y = 32,
           label = "Site A has 25 (3%)\nof patients at study end",
           hjust=0,
           size=3,
           lineheight=.8,
           fontface="bold",
           color=CoporateColours[4]) +
